...
#       Arac fiyati = (80.000) - (0,2*60.000) - (2500*HasarDurumu) + ... + (6.000*VitesTürü)


#   Asama asama Katma Degerler:
#   1-Betimleyici Analitik     2-Teshis/Tani Analitigi     3-Tahminsel Analitik    4-Yönergeli Analitik
...
#   Kategorik Degiskenler (nitel, kalitatif)    -> ornek: cinsiyet, vites turu, model, rütbeler
...
#print(a.dtype)  #-> Array veri tipini verir (elemanlarin veri tipi, örneğin int64, float32 gibi).
...
#...
    ...
    # RESHAPE
    # Tek boyuttan > 2 Boyuta yükseltmek veya 2 Boyuttan > Tek boyuta indirmek gibi islere yarar.
